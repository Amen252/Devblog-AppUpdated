...
<head>
    ...
    <style>
        ...
        body { font-family: 'Plus Jakarta Sans', sans-serif; background-color: #f4f7fe; margin: 0; }
        
        /* Ensure layout works with your sidebar */
    ...
    <main class="main-content">
        <header class="top-header d-flex justify-content-between align-items-center bg-white px-4 py-3 mb-4 shadow-sm rounded-4">
            <div class="d-flex align-items-center gap-3">
                ...
                <button class="btn btn-primary btn-sm rounded-pill px-3 shadow-sm" data-bs-toggle="modal" data-bs-target="#registerModal" style="background-color: var(--primary-blue);">
            ...
            <div class="d-flex align-items-center gap-3">
                ...
                <?php if(isset($_GET['success'])): ?>
                    <span class="badge bg-success-subtle text-success border border-success-subtle px-3 py-2 rounded-pill">Updated!</span>
                <?php endif; ?>
            </div>
        </header>
                        ...
                        <tbody>
                            ...
                            <tr>
                                    ...
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <?php if($row['id'] == $admin_id): ?>
                                                <span class="badge bg-primary-subtle text-primary x-small" style="font-size: 0.65rem;">YOU</span>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-center">
                                    <div class="dropdown">
                                        <button class="btn role-badge <?= $row['role'] == 'admin' ? 'role-admin' : 'role-user' ?> dropdown-toggle border-0 shadow-none" 
                                        ...
                                        <ul class="dropdown-menu shadow border-0 p-2" style="border-radius: 15px;">
                                            <li>
                                                <form method="POST">
                                                    ...
                                                    <button type="submit" name="update_role" class="dropdown-item d-flex align-items-center gap-2 py-2 rounded-3">
                                                        <i class="fas fa-shield-halved text-primary"></i> Make Admin
                                                    </button>
                                                </form>
                                            </li>
                                            <li>
                                                <form method="POST">
                                                    ...
                                                    <button type="submit" name="update_role" class="dropdown-item d-flex align-items-center gap-2 py-2 text-danger rounded-3">
                                ...
                                <td class="text-end">
                                    <a href="delete_user.php?id=<?= $row['id'] ?>" 
                                       class="btn-delete <?= $row['id'] == $admin_id ? 'btn-disabled' : '' ?>" 
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg" style="border-radius: 20px;">
                <div class="modal-header border-0 px-4 pt-4">
                    <h5 class="fw-bold">New User Account</h5>
                ...
                <div class="modal-body p-4">
                    <form action="add_user_process.php" method="POST">
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" class="form-control border-0 bg-light p-2" required style="border-radius: 10px;">
                        </div>
                        <div class="mb-3">
                            <label class="small fw-bold text-muted mb-1">Email Address</label>
                            <input type="email" name="email" class="form-control border-0 bg-light p-2" required style="border-radius: 10px;">
                        </div>
                        <div class="mb-3">
                            <label class="small fw-bold text-muted mb-1">Secure Password</label>
                            <input type="password" name="password" class="form-control border-0 bg-light p-2" required style="border-radius: 10px;">
                        </div>
                        <div class="mb-4">
                            <label class="small fw-bold text-muted mb-1">Account Permission</label>
                            <select name="role" class="form-select border-0 bg-light p-2" style="border-radius: 10px;">
                                <option value="user">Standard User</option>
                                <option value="admin">Administrator</option>
                            </select>
                        </div>
                        <button type="submit" class="btn btn-primary w-100 py-2 fw-bold rounded-3 shadow-sm border-0" style="background-color: var(--primary-blue);">
                            Create User Account
                        </button>
                    </form>
                </div>
